    ...
    sitemap: Ember.computed('i18n.locale', function () {
      ...
      return {
        nodes: [{
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.mu13.caption'),
          title: i18n.t('forms.application.sitemap.mu13.title'),
          children: [{
            link: 'i-i-s-mu13-dfsf1-l',
            caption: i18n.t('forms.application.sitemap.mu13.i-i-s-mu13-dfsf1-l.caption'),
            title: i18n.t('forms.application.sitemap.mu13.i-i-s-mu13-dfsf1-l.title'),
            children: null
          }]
        }]
      };
...
define('ember-app/controllers/i-i-s-mu13-dfsf1-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-mu13-dfsf1-l'
  });
});
define('ember-app/controllers/i-i-s-mu13-dfsf1-e/new', ['exports', 'ember-app/controllers/i-i-s-mu13-dfsf1-e'], function (exports, _iISMu13Dfsf1E) {
  'use strict';
  ...
  var IISmu13dfsf1ENewController = _iISMu13Dfsf1E.default;
  exports.default = IISmu13dfsf1ENewController;
});
define('ember-app/controllers/i-i-s-mu13-dfsf1-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-mu13-dfsf1-e'
     */
    editFormRoute: 'i-i-s-mu13-dfsf1-e'
  });
});
...
define('ember-app/locales/en/forms/i-i-s-mu13-dfsf1-e', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = {
    caption: 'IISmu13dfsf1E'
  };
});
define('ember-app/locales/en/forms/i-i-s-mu13-dfsf1-l', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = {
    caption: 'IISmu13dfsf1L'
  };
});
define("ember-app/locales/en/models/i-i-s-mu13-dfsf1", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-mu13-dfsf1-l', 'ember-app/locales/en/forms/i-i-s-mu13-dfsf1-e', 'ember-app/locales/en/models/i-i-s-mu13-dfsf1'], function (exports, _translations, _iISMu13Dfsf1L, _iISMu13Dfsf1E, _iISMu13Dfsf) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-mu13-dfsf1': _iISMu13Dfsf.default
    },
    ...
    forms: {
      ...
      application: {
        ...
        sitemap: {
          ...
          mu13: {
            ...
            title: 'mu13',
            'i-i-s-mu13-dfsf1-l': {
              caption: 'i-i-s-mu13-dfsf1-l',
              title: 'i-i-s-mu13-dfsf1-l'
            }
          }
        }
      },
      ...
      'i-i-s-mu13-dfsf1-l': _iISMu13Dfsf1L.default,
      'i-i-s-mu13-dfsf1-e': _iISMu13Dfsf1E.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-mu13-dfsf1-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-mu13-dfsf1-l', ['exports'], function (exports) {
  'use strict';
...
define("ember-app/locales/ru/models/i-i-s-mu13-dfsf1", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-mu13-dfsf1-l', 'ember-app/locales/ru/forms/i-i-s-mu13-dfsf1-e', 'ember-app/locales/ru/models/i-i-s-mu13-dfsf1'], function (exports, _translations, _iISMu13Dfsf1L, _iISMu13Dfsf1E, _iISMu13Dfsf) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-mu13-dfsf1', ['exports', 'ember-flexberry-data/utils/attributes'], function (exports, _attributes) {
  'use strict';
  ...
  let defineProjections = exports.defineProjections = function (modelClass) {
    modelClass.defineProjection('dfsf1E', 'i-i-s-mu13-dfsf1', {});

    modelClass.defineProjection('dfsf1L', 'i-i-s-mu13-dfsf1', {});
  };
});
define('ember-app/mixins/regenerated/serializers/i-i-s-mu13-dfsf1-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-mu13-dfsf1', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/custom-inflector-rules', ['exports', 'ember-inflector'], function (exports, _emberInflector) {
  ...
  inflector.irregular('smu13dfsf1', 'Smu13dfsf1s');
...
define('ember-app/models/i-i-s-mu13-dfsf1', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/i-i-s-mu13-dfsf1'], function (exports, _emberCpValidations, _model, _offlineModel, _iISMu13Dfsf) {
  'use strict';
  ...
  const Validations = (0, _emberCpValidations.buildValidations)(_iISMu13Dfsf.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  let Model = _model.default.extend(_offlineModel.default, _iISMu13Dfsf.Model, Validations, {});

  (0, _iISMu13Dfsf.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    this.route('i-i-s-mu13-dfsf1-l');
    this.route('i-i-s-mu13-dfsf1-e', { path: 'i-i-s-mu13-dfsf1-e/:id' });
    this.route('i-i-s-mu13-dfsf1-e.new', { path: 'i-i-s-mu13-dfsf1-e/new' });
  });
...
define('ember-app/routes/i-i-s-mu13-dfsf1-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    modelProjection: 'dfsf1E',
    modelName: 'i-i-s-mu13-dfsf1'
  });
});
define('ember-app/routes/i-i-s-mu13-dfsf1-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'dfsf1E',
    modelName: 'i-i-s-mu13-dfsf1',
    templateName: 'i-i-s-mu13-dfsf1-e'
  });
});
define('ember-app/routes/i-i-s-mu13-dfsf1-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @default 'dfsf1L'
    */
    modelProjection: 'dfsf1L',

    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-mu13-dfsf1'
    */
    modelName: 'i-i-s-mu13-dfsf1',
...
define('ember-app/serializers/i-i-s-mu13-dfsf1-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-mu13-dfsf1-offline', 'ember-app/serializers/application-offline'], function (exports, _iISMu13Dfsf1Offline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISMu13Dfsf1Offline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-mu13-dfsf1', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-mu13-dfsf1', 'ember-app/serializers/application'], function (exports, _iISMu13Dfsf, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISMu13Dfsf.Serializer, {
    /**
